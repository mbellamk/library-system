...
<body style="font: arial, sans-serif;width: 950px;color: #444;margin: 5px auto;width: auto;background: transparent;padding-bottom: 30px;margin-left: auto; margin-right: auto;">
  <div class="container">
    <div class="table-responsive">
      <table class="table" style="width: 950px;">
		<tr>
		  <td height="100" colspan="2" style="background-color: #FDD023; border: thick;font: bold;font-family:fantasy;font-style: pause-after;color:white;display:block; background: -moz-linear-gradient(#FDD023, #FDD023);background: -o-linear-gradient(#FDD023, #FDD023);background: -webkit-linear-gradient(#461D7C, #FDD023);-webkit-box-shadow: rgba(0, 0, 0, 0.2) 0px 2px 2px;-moz-box-shadow: rgba(0, 0, 0, 0.2) 0px 2px 2px;box-shadow: rgba(0, 0, 0, 0.2) 0px 2px 2px;border: 1px solid #FDD023;border-radius: 7px 7px 7px 7px;-moz-border-radius: 7px 7px 7px 7px;-webkit-border: 7px 7px 7px 7px;">
		    <tiles:insertAttribute name="header"/>
		  </td>
		</tr>
		<tr>
		   <td height="10" width="50" style="height: 35px;width: 100%;float: left;margin: auto auto auto auto;color: #222;background: #461D7C; background: -moz-linear-gradient(#461D7C, #461D7C);background: -o-linear-gradient(#461D7C, #461D7C);background: -webkit-linear-gradient(#461D7C, #461D7C);-webkit-box-shadow: rgba(0, 0, 0, 0.2) 0px 2px 2px;-moz-box-shadow: rgba(0, 0, 0, 0.2) 0px 2px 2px;box-shadow: rgba(0, 0, 0, 0.2) 0px 2px 2px;border: 1px solid #461D7C;border-radius: 7px 7px 7px 7px;-moz-border-radius: 7px 7px 7px 7px;-webkit-border: 7px 7px 7px 7px;">
		     <tiles:insertAttribute name="menu"/>
		   </td>
		</tr>
		<tr>
			<td>
				<ul id="images" style="margin: 0;padding: 0;list-style: none;position: relative; width:950px;">
			        <li style="display: block;overflow: hidden;padding: 0;float: left;width: 155px;height: 300px;"><img src="http://www.kln.ac.lk/ss/joomlaworkshop/test_18/images/stories/library/library011.jpg" width="600" height="300" alt="seascape_one" /><h3 style="position: absolute; top: 200px; left: 0; width: 100%;"><span style="color: white; font: bold 24px/45px Helvetica, Sans-Serif; letter-spacing: -1px; background: rgb(0, 0, 0);background: rgba(0, 0, 0, 0.7);padding: 10px;">Presentation Room</span></h3></li>
			        <li style="display: block;overflow: hidden;padding: 0;float: left;width: 155px;height: 300px;"><img src="http://www.scert.kerala.gov.in/images/img/library.jpg" width="600" height="300" alt="seascape_two" /><h3 style="position: absolute; top: 200px; left: 0; width: 100%;"><span style="color: white; font: bold 24px/45px Helvetica, Sans-Serif; letter-spacing: -1px; background: rgb(0, 0, 0);background: rgba(0, 0, 0, 0.7);padding: 10px;">Discussion Room</span></h3></li>
			        <li style="display: block;overflow: hidden;padding: 0;float: left;width: 155px;height: 300px;"><img src="http://www.burdekin.qld.gov.au/wp/media/2011/11/Library-Main1.jpg?81eba0" width="600" height="300" alt="seascape_three" /><h3 style="position: absolute; top: 200px; left: 0; width: 100%;"><span style="color: white; font: bold 24px/45px Helvetica, Sans-Serif; letter-spacing: -1px; background: rgb(0, 0, 0);background: rgba(0, 0, 0, 0.7);padding: 10px;">Personal Room</span></h3></li>
			        <li style="display: block;overflow: hidden;padding: 0;float: left;width: 155px;height: 300px;"><img src="http://www.pdgm.com/getmedia/49986e29-2fba-4629-8a09-591205b91ed4/Library_1400_800.jpg.aspx" width="600" height="300" alt="seascape_four" /><h3 style="position: absolute; top: 200px; left: 0; width: 100%;"><span style="color: white; font: bold 24px/45px Helvetica, Sans-Serif; letter-spacing: -1px; background: rgb(0, 0, 0);background: rgba(0, 0, 0, 0.7);padding: 10px;">Our Catalog</span></h3></li>
			        <li style="display: block;overflow: hidden;padding: 0;float: left;width: 155px;height: 300px;"><img src="https://it.unt.edu/sites/default/files/lib_lots_users.png" width="600" height="300" alt="seascape_five" /><h3 style="position: absolute; top: 200px; left: 0; width: 100%;"><span style="color: white; font: bold 24px/45px Helvetica, Sans-Serif; letter-spacing: -1px; background: rgb(0, 0, 0);background: rgba(0, 0, 0, 0.7);padding: 10px;">Digital Library</span></h3></li>
			        <li style="display: block;overflow: hidden;padding: 0;float: left;width: 155px;height: 300px;"><img src="https://upload.wikimedia.org/wikipedia/commons/0/08/Vic_State_Library_Reading_Room_Pano,_19.07.06.jpg" width="600" height="300" alt="seascape_four" /><h3 style="position: absolute; top: 200px; left: 0; width: 100%;"><span style="color: white; font: bold 24px/45px Helvetica, Sans-Serif; letter-spacing: -1px; background: rgb(0, 0, 0);background: rgba(0, 0, 0, 0.7);padding: 10px;">Reading Room</span></h3></li>
			        <li style="display: block;overflow: hidden;padding: 0;float: left;width: 155px;height: 300px;"><img src="http://static1.squarespace.com/static/55b0cc74e4b08745c530e049/t/55c4914ee4b0c826968796c4/1438945623527/TheLibrary-064-12.JPG?format=2500w" width="600" height="300" alt="seascape_five" /><h3 style="position: absolute; top: 200px; left: 0; width: 100%;"><span style="color: white; font: bold 24px/45px Helvetica, Sans-Serif; letter-spacing: -1px; background: rgb(0, 0, 0);background: rgba(0, 0, 0, 0.7);padding: 10px;">Main Building</span></h3></li>
			    </ul>
			</td>
		</tr>
		<tr>
		   <td height="350" width="400" style="border: thick;font: bold; background: -moz-linear-gradient(#fff, #FDD023);background: -o-linear-gradient(#fff, #FDD023);background: -webkit-linear-gradient(#fff, #FDD023);-webkit-box-shadow: rgba(0, 0, 0, 0.2) 0px 2px 2px;-moz-box-shadow: rgba(0, 0, 0, 0.2) 0px 2px 2px;box-shadow: rgba(0, 0, 0, 0.2) 0px 2px 2px;border: 1px solid #fff;border-radius: 7px 7px 7px 7px;-moz-border-radius: 7px 7px 7px 7px;-webkit-border: 7px 7px 7px 7px;">
		      <tiles:insertAttribute name="title" /><br>
		      <tiles:insertAttribute name="body"/>
		  </td>
		</tr>
		<tr>
		  <td height="50"  colspan="2" style="background-color: grey; border: thick;font: bold; background: -moz-linear-gradient(#461D7C, #808080);background: -o-linear-gradient(#461D7C, #808080);background: -webkit-linear-gradient(#461D7C, #808080);-webkit-box-shadow: rgba(0, 0, 0, 0.2) 0px 2px 2px;-moz-box-shadow: rgba(0, 0, 0, 0.2) 0px 2px 2px;box-shadow: rgba(0, 0, 0, 0.2) 0px 2px 2px;border: 1px solid #fff;border-radius: 7px 7px 7px 7px;-moz-border-radius: 7px 7px 7px 7px;-webkit-border: 7px 7px 7px 7px;">
