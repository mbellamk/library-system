...
<table style="width:auto;border-collapse: collapse;border: 1px solid black;">
    <thead style="text-align:center ;padding: 8px;background-color: #FDD023;color: white;border: 1px solid black;">
      <tr style="border: 1px solid black; ">
      	...
      	<th style="text-align:center ;padding: 8px;border: 1px solid black;"><a href="${url}/student/popularlist" style="color: #461D7C;">Pouplar Books</a></th>
...
<table style="width:100%;border-collapse: collapse;border: 1px solid black;">
    <thead style="text-align:center ;padding: 8px;background-color: #461D7C;color: white;border: 1px solid black;">
      <tr style="border: 1px solid black; ">
        ...
        <th style="text-align:center ;padding: 8px;border: 1px solid black;">Available copies</th>
        <th style="text-align:center ;padding: 8px;border: 1px solid black;">Operations</th>
       </tr>
    </thead>
    <tbody style="border: 1px solid black;">
  <c:forEach var="book" items="${bookList}">
      <tr style="border: 1px solid black;">
        <td style="border: 1px solid black;padding: 8px;">${book.bookName}</td>
        <td style="border: 1px solid black;padding: 8px;">${book.bookAuthor}</td>
        <td style="border: 1px solid black;padding: 8px;">${book.bookPublisher}</td>
        <td style="border: 1px solid black;padding: 8px;">${book.bookCategory}</td>
        <td style="border: 1px solid black;padding: 8px;">${book.bookIsbn}</td>
        <td style="border: 1px solid black;padding: 8px;">${book.availableCopies}</td>
        <td style="border: 1px solid black;padding: 8px;"><a href="${url}/student/reserve/${book.bookId}/${book.availableCopies}/${book.bookName}">Reserve</a> </td>
      </tr>
  </c:forEach>
    </tbody>
  </table>
