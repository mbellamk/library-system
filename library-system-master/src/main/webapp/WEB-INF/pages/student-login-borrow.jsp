...
<body>
<h3 style="font-family:sans-serif;font:bold; color:#461D7C">Welcome to our library</h3>
...
<table style="width:100%;border-collapse: collapse;border: 1px solid black;">
    <thead style="text-align:center ;padding: 8px;background-color: #461D7C;color: white;border: 1px solid black;">
      <tr style="border: 1px solid black; ">
        <th style="text-align:center ;padding: 8px;border: 1px solid black;">Book Id</th>
        <th style="text-align:center ;padding: 8px;border: 1px solid black;">Book Name</th>
        <th style="text-align:center ;padding: 8px;border: 1px solid black;">Check out date</th>
        <th style="text-align:center ;padding: 8px;border: 1px solid black;">due date</th>
       </tr>
    </thead>
    <tbody style="border: 1px solid black;">
  <c:forEach var="check" items="${borrowList}">
      <tr style="border: 1px solid black;">
        <td style="border: 1px solid black;padding: 8px;font-size:medium; ">${check.bookId}</td>
        <td style="border: 1px solid black;padding: 8px;">${check.bookName}</td>
        <td style="border: 1px solid black;padding: 8px;">${check.checkoutDate}</td>
        <td style="border: 1px solid black;padding: 8px;">${check.returnDate}</td>
      </tr>
  </c:forEach>
    </tbody>
  </table>
